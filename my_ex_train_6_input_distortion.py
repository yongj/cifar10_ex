...
def train_nn(restart=True):
    ...
    with tf.Session() as sess:
        ...
        for i in range(300000):
            ...
            _ = sess.run([train_step],feed_dict={x:train_images,labels:train_labels,bat_size:BAT_SIZE_TRANING,keep_prob:1.0})
            ...
            if (i%10==0):           # evaluate on batch data every 20 steps
                output_loss = sess.run([loss],feed_dict={x:train_images,labels:train_labels,bat_size:BAT_SIZE_TRANING,keep_prob:1.0})
            ...
            if (i%1000==0):      # send me an email every 100 steps
